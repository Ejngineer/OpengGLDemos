...
quadSphere::quadSphere(float radius, int sectors, int stacks, bool smooth)
{
	this->radius = radius;
...
void quadSphere::DrawInstanced(int amount)
{
	glBindVertexArray(VAO);
...
void quadSphere::MakeVerticesFlat()
{
	struct Vertex
	{
		float x, y, z, s, t;
...
void quadSphere::MakeVerticesSmooth()
{
...
void quadSphere::MakeInterleavedVertices()
{
...
std::vector<float> quadSphere::CalcNormal(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3)
{
...
std::vector<float> quadSphere::CalcTangent(
...
void quadSphere::addVertex(float x1, float y1, float z1)
{
...
void quadSphere::addNormal(float x, float y, float z)
{
	Normals.push_back(x);
	Normals.push_back(y);
	Normals.push_back(z);
...
void quadSphere::addTangent(float x, float y, float z)
{
...
void quadSphere::addBiTangent(float x, float y, float z)
{
...
void quadSphere::addTexCoord(float x, float y)
{
	TexCoords.push_back(x);
	TexCoords.push_back(y);
}

void quadSphere::addIndices(unsigned int x, unsigned int y, unsigned int z)
{
