...
#ifndef __CUBESPHERE_H
#define __CUBESPHERE_H
...
private:
    ...
    static void computeFaceTangents(const float v1[3], const float v2[3], const float v3[3], const float t1[2], const float t2[2], const float t3[2], float tangents[6]);
    ...
    void addTangent(const float tx, const float ty, const float tz);
    void addTangents(const float t1[6], const float t2[6], const float t3[6], const float t4[6]);
    void addBiTangent(const float bx, const float by, const float bz);
    void addBiTangents(const float b1[6], const float b2[6], const float b3[6], const float b[6]);
